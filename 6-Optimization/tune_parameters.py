...
BASE            = os.path.expanduser("~/Centipede_MUJOCO-main")
GENERATE_SCRIPT = os.path.join(BASE, "3-Model", "10-Archives", "1-Centipede", "generate_mjcf.py")
XML_OUTPUT_GEN  = os.path.join(BASE, "3-Model", "10-Archives", "1-Centipede", "centipede.xml")
XML_OUTPUT      = os.path.join(BASE, "3-Model", "1-Centipede", "centipede.xml")
CONTROL_DIR     = os.path.join(BASE, "1-Control")
CONFIG_PATH     = os.path.join(CONTROL_DIR, "config.yaml")
TUNE_DIR        = os.path.join(BASE, "4-Data", "tuning")
OPT_DIR         = os.path.join(BASE, "6-Optimization", "results")
