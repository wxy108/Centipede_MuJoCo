...
XML_PATH    = os.path.join(BASE, "3-Model", "2-Centipede_FARMS", "centipede.xml")
XML_BACKUP  = XML_PATH + ".backup"
CONTROL_DIR = os.path.join(BASE, "1-Control")
CONFIG_PATH = os.path.join(CONTROL_DIR, "farms_config.yaml")
TUNE_DIR    = os.path.join(BASE, "4-Data", "tuning_FARMS")
OPT_DIR     = os.path.join(BASE, "6-Optimization", "results_FARMS")
...
class FARMSCentipedeOptimizer:
    ...
    INITIAL_VALUES = {
        ...
        'pitch_stiffness':   1.0e-02,
        'pitch_damping':     1.0e-06,
    }
