"""
farms_run.py — Simulation runner for the FARMS centipede model
===============================================================
Loads farms_config.yaml, creates the controller, runs in viewer or headless mode.
Auto-creates timestamped output folders:
    4-Data/run_MM_DD_YYYY/farms_results.npz
    5-Video/run_MM_DD_YYYY/output_FARMS.mp4   (if --video flag used)

Usage:
    python farms_run.py                              # viewer, default config
...
from farms_kinematics import FARMSModelIndex, N_BODY_JOINTS, N_LEGS, N_LEG_DOF
from farms_controller import FARMSTravelingWaveController, load_config

# ── Paths ─────────────────────────────────────────────────────────────────────
SCRIPT_DIR   = os.path.dirname(os.path.abspath(__file__))
BASE_DIR     = os.path.join(SCRIPT_DIR, "..")   # 3-Model/../ = project root
DEFAULT_XML = os.path.join(
    os.path.dirname(os.path.abspath(__file__)),
    "..", "3-Model", "2-Centipede_FARMS", "centipede.xml"
)
DEFAULT_CFG  = os.path.join(SCRIPT_DIR, "farms_config.yaml")
